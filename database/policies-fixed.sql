...
-- Grant permissions on views (views don't support RLS, they inherit permissions from underlying tables)
...
-- Note: Views cannot have RLS policies. They inherit security from their underlying tables.
-- The security is enforced through the RLS policies on the base tables (profiles, community_posts, etc.)
-- and through proper access control in the application layer.